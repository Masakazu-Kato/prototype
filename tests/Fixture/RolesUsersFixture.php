...
class RolesUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'user_id' => 1,
                'created' => '2018-08-28 22:09:00',
                'modified' => '2018-08-28 22:09:00'
            ],
        ];
        parent::init();
    }
